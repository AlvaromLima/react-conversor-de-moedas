...
// npm install react-bootstrap@1.0.0-beta.16
...
function ConversorMoedas() {
  ...
  const FIXER_URL = 'http://data.fixer.io/api/latest?access_key=1a4fbe093597c6d53b7a9a1d24a67385';
  ...
  function handleValor(event){
    // adicionar somente numeros usando /\D/g(diferente de números) e substituir por ''
  ...
  function converter(event){
    ...
    if (event.currentTarget.checkValidity() === true){
       // implementar a chamada ao Fixer.io por axios
